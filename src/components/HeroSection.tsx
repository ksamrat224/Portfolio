...
const HeroSection = () => {
  ...
  return (
    <section
      id="home"
      className="relative h-screen bg-hero text-hero-foreground flex items-center"
    >
      ...
      <div className="container relative z-10">
        <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
          <div className="order-2 md:order-1 max-w-3xl">
            <p className="text-accent-blue-light font-medium mb-4 animate-fade-in">
              Hello, I'm
            </p>
            ...
            <p className="text-xl md:text-2xl font-light mb-8 text-gray-300 leading-relaxed animate-fade-in animation-delay-200">
              ...
              creating modern and responsive web applications focused on user
              experience.
            </p>
          ...
          <div className="order-1 md:order-2 animate-fade-in mb-6 md:mb-0">
            <Avatar className="h-48 w-48 md:h-64 md:w-64 rounded-full ring-4 ring-accent-blue/30 shadow-lg overflow-hidden">
              <AvatarImage
                src="/p.jpg"
                alt="Your Name"
                className="object-cover w-full h-full"
              />
              <AvatarFallback className="bg-accent-blue text-white text-4xl">
                Samrat Karki
              </AvatarFallback>
            </Avatar>
          </div>
